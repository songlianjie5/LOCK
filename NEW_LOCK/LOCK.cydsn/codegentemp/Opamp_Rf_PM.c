...
#if(!Opamp_Rf_CHECK_DEEPSLEEP_SUPPORT)
    static Opamp_Rf_BACKUP_STRUCT Opamp_Rf_backup =
    {
        0u, /* enableState */
    };
#endif /* (Opamp_Rf_CHECK_DEEPSLEEP_SUPPORT) */


/*******************************************************************************
* Function Name: Opamp_Rf_SaveConfig
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Opamp_Rf_RestoreConfig
********************************************************************************
*
* Summary:
*  Empty function. Included for consistency with other components.
...
*
* Global variables:
*  Opamp_Rf_backup: The structure field 'enableState' is modified
...
{
#if(!Opamp_Rf_CHECK_DEEPSLEEP_SUPPORT)
    if(Opamp_Rf_CHECK_PWR_MODE_OFF)
    {
        Opamp_Rf_backup.enableState = 1u;
        Opamp_Rf_Stop();
    }
    else /* The component is disabled */
    {
        Opamp_Rf_backup.enableState = 0u;
    }
#endif /* (Opamp_Rf_CHECK_DEEPSLEEP_SUPPORT) */
}
...
*
* Global variables:
*  Opamp_Rf_backup: The structure field 'enableState' is used to
...
{
#if(!Opamp_Rf_CHECK_DEEPSLEEP_SUPPORT)
    if(0u != Opamp_Rf_backup.enableState)
    {
